<x-admin.layout title="Products">
    <main class="mx-auto grid w-full max-w-[90rem] gap-8 px-6 py-8 lg:grid-cols-[24rem_1fr] lg:px-8">
        ...
        <section class="min-w-0">
            ...
            <form class="mt-6 grid gap-3 rounded-lg border border-zinc-200 bg-white p-4 md:grid-cols-[1fr_11rem_11rem_auto]" method="GET" action="{{ route('admin.products.index') }}">
                <div>
            ...
            @if ($filters['search'] || $filters['status'] !== 'all' || $filters['sort'] !== 'newest')
                <div class="mt-3 flex justify-end">
                    <a class="text-sm font-semibold text-zinc-500 transition hover:text-red-700" href="{{ route('admin.products.index') }}">Clear filters</a>
                </div>
            @endif
