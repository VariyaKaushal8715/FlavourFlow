        ...
        <div class="mx-auto flex w-full max-w-4xl items-center justify-between gap-6 px-6 py-4 lg:px-8">
            <a class="flex items-center gap-3" href="{{ route('admin.index') }}">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Back to products</p>
                </div>
            </a>

            <a class="text-sm font-semibold text-zinc-600 transition hover:text-red-700" href="{{ route('admin.index') }}">Cancel</a>
        </div>
    </header>
