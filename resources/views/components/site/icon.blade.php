...
@switch($name)
    ...
    @case('whatsapp')
        <svg {{ $attributes->merge(['class' => $svgClass, 'viewBox' => '0 0 24 24', 'fill' => 'currentColor', 'aria-hidden' => 'true']) }}>
            <path d="M12.012 2c-5.506 0-9.989 4.478-9.99 9.984a9.96 9.96 0 0 0 1.333 4.993L2 22l5.233-1.237a9.96 9.96 0 0 0 4.779 1.221h.004c5.505 0 9.988-4.478 9.989-9.984A9.96 9.96 0 0 0 12.012 2Zm0 18.315h-.003a8.3 8.3 0 0 1-4.234-1.166l-.304-.18-3.149.744.757-3.073-.198-.315a8.29 8.29 0 0 1-1.272-4.341c.001-4.577 3.725-8.3 8.303-8.3 2.217 0 4.301.864 5.869 2.433a8.27 8.27 0 0 1 2.43 5.868c-.001 4.578-3.725 8.301-8.303 8.301Zm4.555-6.22c-.25-.125-1.478-.729-1.707-.812-.229-.084-.396-.125-.563.125-.167.25-.646.812-.792.979-.146.167-.292.188-.542.063a6.85 6.85 0 0 1-2.012-1.24 7.55 7.55 0 0 1-1.393-1.737c-.146-.25-.016-.386.109-.51.112-.113.25-.292.375-.438.125-.146.167-.25.25-.417.083-.167.042-.313-.021-.438-.063-.125-.563-1.354-.771-1.854-.203-.487-.41-.421-.563-.429l-.479-.008c-.167 0-.438.063-.667.313s-.875.854-.875 2.083.896 2.417 1.021 2.583c.125.167 1.763 2.693 4.27 3.777 2.508 1.084 2.508.723 2.967.677.458-.046 1.478-.604 1.687-1.188.208-.583.208-1.083.146-1.188-.063-.104-.229-.167-.479-.292Z" />
        </svg>
        @break
    @case('leaf')
        <svg {{ $attributes->merge(['class' => $svgClass, 'viewBox' => '0 0 24 24', 'fill' => 'none', 'stroke' => 'currentColor', 'stroke-linecap' => 'round', 'stroke-linejoin' => 'round', 'stroke-width' => '1.8', 'aria-hidden' => 'true']) }}>
