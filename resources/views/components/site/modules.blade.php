    ...
    <div class="mx-auto w-full max-w-7xl px-6 lg:px-8">
        ...
        <div class="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            @foreach ($modules as $module)
                <article class="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm shadow-zinc-200/70 transition hover:-translate-y-1 hover:border-brand-primary hover:shadow-lg hover:shadow-zinc-950/10">
                    <p class="text-sm font-semibold text-brand-primary">{{ $module['name'] }}</p>
